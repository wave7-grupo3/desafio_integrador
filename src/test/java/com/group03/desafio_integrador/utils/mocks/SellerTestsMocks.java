...
public class SellerTestsMocks {
    ...
    public static List<ProductAdvertising> mockProductList() {
        ...
        ProductAdvertising productFresh = new ProductAdvertising(16L,
        ...
        ProductAdvertising productRefrigerated = new ProductAdvertising(17L,
                LocalDate.parse("2022-11-30"),
                LocalDateTime.of(2022, 11, 9, 11, 43, 0),
                "Iogurte",
                "teste",
        ...
        ProductAdvertising productFrozen = new ProductAdvertising(18L,
                LocalDate.parse("2022-11-30"),
                LocalDateTime.of(2022, 11, 9, 11, 43, 0),
                "Polpa de Morango",
                "teste",
